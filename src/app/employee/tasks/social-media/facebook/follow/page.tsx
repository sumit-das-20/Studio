...
const facebookTasks = Array.from({ length: 12 }, (_, i) => ({
    ...
    pageName: singleCampaign.pageName,
}));
...
export default function FacebookFollowPage() {
    ...
    const handleCompleteTask = (taskId: number) => {
        ...
        setCompletedTasks(prev => new Set(prev).add(taskId));
         ...
         // In a real app, you would open the link to the buyer's Facebook page:
         // window.open('https://facebook.com/SOME_PAGE_FROM_CAMPAIGN', '_blank');
    }
                    ...
                    return (
                        <Card key={task.id} className={isCompleted ? 'bg-muted/50' : ''}>
                            <CardHeader>
                                ...
                                <CardDescription>Page: <strong>{task.pageName}</strong></CardDescription>
                            </CardHeader>
                            <CardContent>
