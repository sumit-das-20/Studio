        ...
        <div className="flex min-h-screen items-center justify-center bg-background p-4">
            <Card className="w-full max-w-md">
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter your details below to create an employee account.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                     {error && (
                    ...
                    {success && (
                        <Alert variant="default" className="mb-4 border-green-500 text-green-700 dark:border-green-600 dark:text-green-400">
                            ...
                            <AlertDescription>Your employee account has been created successfully! You can now log in.</AlertDescription>
                        </Alert>
                    )}
                    <Form {...form}>
