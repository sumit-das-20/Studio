...
const tasks: SimpleTaskType[] = [
  { id: 4, question: 'What is your age?', reward: 0.1 },
  { id: 5, question: 'What is your favorite movie genre?', reward: 0.1 },
  { id: 6, question: 'What brand of phone do you use?', reward: 0.1 },
];
